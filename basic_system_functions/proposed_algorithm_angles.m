function Zbar = proposed_algorithm_angles(subY, Omega, indx_S, A, B, Imax, tau_Y, tau_S, rho, type, numOfnz)
  ...
  for i=1:Imax
      ...
      Omega_S(indx_S(1:min(300+5*i, Gt*Gr))) = 1;
      K3 = zeros(Gr*Gt);
